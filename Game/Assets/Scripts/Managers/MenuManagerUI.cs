    ...
    public void OpenMenu(int index) 
    {
        for (int i = 0; i < Menus.Length; i++)
        {
            if (i == index)
            {
                ...
                for (int j = 0; j < Menus[i].WritingTexts.Length; j++) { MenuManager.WriteText(Menus[i].WritingTexts[j].WritingText, 
            ...
            else if (Menus[i].MenuTransform.gameObject.activeSelf)
            {
                ...
                for (int j = 0; j < Menus[i].WritingTexts.Length; j++) { MenuManager.WriteText(Menus[i].WritingTexts[j].WritingText, "", Menus[i].WritingTexts[j].Time); }
            }
        }
    }
